...
function handleCalculations () {
  ...
  shipping.textContent = subTotalPrice !== '0.00' ? '₹0.5' : 'Free'
  
  total.textContent = '₹' + ((+subTotalPrice) + (+taxesPrice) + (+subTotalPrice > 0 ? 0.5 : 0)).toFixed(2)
  document.getElementById("total").value=((+subTotalPrice) + (+taxesPrice) + (+subTotalPrice > 0 ? 0.5 : 0)).toFixed(2);
}

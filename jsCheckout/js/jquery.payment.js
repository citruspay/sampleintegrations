...
(function() {
  ...
  cards = [
    /*{
      ...
      type: 'maestro',
      pattern: /^(?:5[0678]\d\d|6304|6390|6220|67\d\d)\d{8,15}$/,  //^(5(018|0[23]|[68])|6(39|7))/
      format: defaultFormat,
      ...
      type: 'mastercard',
      pattern: /^5[1-5]/, //changes in pattern
      format: defaultFormat,
      length: [16],
      cvcLength: [3],
      luhn: true
      ...
      type: 'discover',
      pattern: /^(6011|65|64[4-9]|622)/,//^6([045]|22)/,
      format: defaultFormat,
      length: [16],
      cvcLength: [3],
      luhn: true
